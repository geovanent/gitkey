...
# Quick commands:
#   gitkey --new      # wizard: new client + ssh-keygen
#   gitkey --config   # toggle sign_commits per client, edit identity
#   gitkey --bind -p client1   # per-repo SSH key (multiple keys at once)
